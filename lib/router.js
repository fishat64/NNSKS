...
Router.route('/verify/', function () { Router.go("/"); });
Router.route('/search/', function () { Router.go("/"); });
Router.route('/get/', function () { Router.go("/"); });
Router.route('/DLKEY/', function () { Router.go("/"); });
Router.route('/delete/', function () { Router.go("/"); });
